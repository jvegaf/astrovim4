return {
  ...
  config = function()
    ...
    command("VisualSearch", function(input) browse.input_search(input) end, {})
    ...
    command("VisualBookmarks", function(input) browse.open_bookmarks { bookmarks = bookmarks, visual_text = input } end)
